#!/usr/bin/env python
"""
Safety Data Collection Script
==============================
This script collects trajectory data with safety labels for training safety models.
It generates random trajectories until collisions are detected, then labels all
points in the trajectory based on their distance to the collision point.

The safety score is binary:
- 0 (Unsafe): Robot will collide within 5 steps
- 1 (Safe): Robot is more than 5 steps away from collision

Usage:
    python collect_safety_data.py
...
if __name__ == "__main__":
    try:
        ...
        # =====================================================================
        NUM_TRAJECTORIES = 500        # Number of trajectories to collect
        # =====================================================================
        
        collector = SafetyDataCollector()
        collector.run_collection(num_trajectories=NUM_TRAJECTORIES)
