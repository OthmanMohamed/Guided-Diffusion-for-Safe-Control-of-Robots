...
It collects trajectories from the TurtleBot ROS simulation environment,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Collect demonstration data for TurtleBot training')
    parser.add_argument('--num-trials', type=int, default=3000,
                      help='Number of trials to collect')
    parser.add_argument('--save-images', action='store_true',
                      help='Save camera images')
    parser.add_argument('--plot-trajectories', action='store_true', default=True,
                      help='Save trajectory plots')
    parser.add_argument('--use-obstacles', action='store_true', default=True,
                      help='Enable obstacle avoidance')
    parser.add_argument('--expert-mode', action='store_true',
                      help='Use expert demonstrations (False for random exploration)')
    parser.add_argument('--output-filename', type=str, 
                      default='../data/demonstration/demonstration_data.pkl',
                      help='Output filename for collected data')
